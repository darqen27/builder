...
rec {
  ...
  mods = bevos.mods // {
    ...
    ElectricalAge = mkMod {
      name = "ElectricalAge-51.5";
      src = fetchurl {
        url = https://madoka.brage.info/baughn/ElectricalAge-51.5.jar;
        sha256 = "34f3264a7b890d19ba2e15ff258519d538504aff7effca1916087a81a075b403";
      };
    };
