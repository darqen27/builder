...
recipes.remove(<rftools:dimensionalShardBlock>);
NEI.hide(<rftools:dimensionalShardBlock>);
recipes.remove(<rftools:dimensionalShardItem>);
NEI.hide(<rftools:dimensionalShardItem>);
...
NEI.hide(<rftools:environmentalControllerBlock>);
...
NEI.hide(<rftools:remoteStorageBlock>);
