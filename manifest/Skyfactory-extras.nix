{
  ...
  "computronics" = {
    ...
    "filename" = "Computronics-1.10.2-1.6.2.jar";
    "version" = "1.10.2-1.6.2";
    "encoded" = "Computronics-1.10.2-1.6.2.jar";
    "type" = "local";
    "md5" = "673712dfa72a1231fbdbe7053e1f2584";
  };
  "deep-resonance" = {
  ...
  "eleccore-rendering-library" = {
    "src" = "https://minecraft.curseforge.com/projects/eleccore-rendering-library/files/2388784/download";
    "version" = "1.10.2-1.7.409";
    "title" = "ElecCore | Rendering Library";
    "projectID" = 227391;
    "filename" = "ElecCore-1.10.2-1.7.409.jar";
    "dependencies" = [];
    "encoded" = "ElecCore-1.10.2-1.7.409.jar";
