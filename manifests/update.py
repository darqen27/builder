...
#!nix-shell -i python -p python27Packages.futures pythonPackages.beautifulsoup pythonPackages.lxml
#
# This autogenerates .nix files from the .json input file(s).
#
