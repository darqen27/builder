{
  ...
  "lunatriuscore" = {
    ...
    "version" = "1.7.10-1.1.2.21-universal";
    "title" = "LunatriusCore";
    "projectID" = 225605;
  ...
  "reauth" = {
    "src" = "https://minecraft.curseforge.com/projects/reauth/files/2370017/download";
    "version" = "1.7.10-3.4.1";
    "title" = "ReAuth";
    "projectID" = 237701;
    "filename" = "ReAuth-1.7.10-3.4.1.jar";
    "dependencies" = [];
    "encoded" = "ReAuth-1.7.10-3.4.1.jar";
    "projectPage" = "https://minecraft.curseforge.com/projects/reauth";
    "type" = "remote";
    "side" = "client";
    "md5" = "27f31f902352b42accfc8ac118cbd3a0";
  };
  "schematica" = {
    "src" = "https://minecraft.curseforge.com/projects/schematica/files/2274295/download";
    "version" = "1.7.10-1.7.6.131-universal";
    "title" = "Schematica";
    "projectID" = 225603;
