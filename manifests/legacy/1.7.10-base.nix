[
  {
    name = "eirairc-mc1.7.10-2.9.402.jar";
    filename = "eirairc-mc1.7.10-2.9.402.jar";
    url = "https://minecraft.curseforge.com/projects/eirairc/files/2281173/download";
    md5 = "03fdd71777fd346d4b8bae1ce8b68963";
  }
  {
    name = "HelpFixer-1.0.7.jar";
    filename = "HelpFixer-1.0.7.jar";
    url = "https://minecraft.curseforge.com/projects/helpfixer/files/2223813/download";
    md5 = "0d6ce4776f981f97a13ab02029b5fb4d";
  }
  {
    name = "PerfectSpawn-1.1.jar";
    filename = "PerfectSpawn-1.1.jar";
    url = "https://minecraft.curseforge.com/projects/perfect-spawn/files/2212916/download";
    md5 = "eb2fada9ee62167611a833d3d71d95d3";
  }
  {
    name = "Morpheus-1.7.10-1.6.21.jar";
